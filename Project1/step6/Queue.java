public class Queue {
    ...
    /**
     *Returns a Queue with all the Tweets that do not contain the given String
     */
    ...
    /**
     *Returns a Queue with all the Tweets that contain the date given by String
     */
    public Queue filterForDate( String keyword){
        ...
        int count = 0;
            while(count < this.length){
            if (n.data.containsDate(keyword)){
                newQ.push(newQ, n.data);
                n= n.next;
            }
            else{
