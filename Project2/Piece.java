public abstract class Piece{
    ...
    /**
     * This function takes a location and checks to see if the move is possible. it returns true if it is.
     */
    protected abstract boolean checkMove(Location toSpot);
 
     /**
     * This function takes a location and makes the move if it is possible. it returns true if it was.
     */
